...
public class SecretNoteEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_secret_note_edit);

        dbHelper = new TodoDbHelper(this);
        editTitle = findViewById(R.id.edit_s_title);
        editContent = findViewById(R.id.edit_s_content);
        editRemarks = findViewById(R.id.edit_s_remarks);
        scrollView = findViewById(R.id.scroll_secret_edit);
        ...
        MaterialButton btnSave = findViewById(R.id.btn_secret_item_save);
        MaterialButton btnDelete = findViewById(R.id.btn_secret_item_delete);

        currentItem = (SecretNoteItem) getIntent().getSerializableExtra("note_item");
        ...
        btnDelete.setOnClickListener(v -> {
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("예", (dialog, which) -> {
                        dbHelper.deleteSecretNote(currentItem.getId());
    ...
    private boolean saveNote() {
        ...
        if (currentItem == null) {
            SecretNoteItem newItem = new SecretNoteItem(title, content, remarks, now);
            dbHelper.addSecretNote(newItem);
        } else {
            currentItem.setTitle(title);
            currentItem.setContent(content);
            currentItem.setRemarks(remarks);
            dbHelper.updateSecretNote(currentItem);
        }
        return true;
    }
}
